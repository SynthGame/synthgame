      ...
      <g>
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="knob_1-01" transform="translate(3.000000, 3.000000)">
                ...
                <g :style="{transition: '.1s all'}" :transform="'rotate(' + (((this.value / (this.max - (this.min*0.9))) * 300) + (this.max*1.095)) + ' 264 285) translate(0, 206)'" >
                  <defs>
                ...
                <g :transform="'rotate(' + (((this.value / (this.max - (this.min))) * 359.8) - (this.max*1.095)) + ' 264 285) translate(2, 205)'" >
