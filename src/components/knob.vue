      ...
      <g>
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="knob_1-01" transform="translate(3.000000, 3.000000)">
                ...
                <g v-if="this.module === 'filter'" style="background:red;transform:scale(3)">
                  <rect x="9.6" y="10.3" class="st15" width="107.1" height="110.8"/>
                	<polyline :stroke="knobColor" stroke-width="5.796" class="st3" points="41.8,110.4 18.4,110.4 18.4,19.5 107.4,19.5 107.4,110.4 84.4,110.4 	"/>
                  <polyline :stroke="knobColor" stroke-width="5.796" class="st3" points="88.3,106.4 84.2,110.5 84.2,110.5 88.3,114.4 	"/>
                	<polyline :stroke="knobColor" stroke-width="5.796" class="st3" points="38.7,106.4 42.8,110.5 42.8,110.5 38.7,114.4 	"/>
                </g>
