<template>
  <div class="module">
    ...
    <module-display
      fill="#e4e259"
      module="envelope"
      :knobs="[{name: 'attack', min: 1, max: 100, value: this.attackOpponent},
                {name: 'decay', min: 1, max: 100, value: this.decayOpponent},
                {name: 'sustain', min: 1, max: 100, value: this.sustainOpponent},
                {name: 'release', min: 1, max: 100, value: this.releaseOpponent},
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      attackOpponent: state => state.gameState.opponent.envelope.attack,
      decayOpponent: state => state.gameState.opponent.envelope.decay,
      sustainOpponent: state => state.gameState.opponent.envelope.sustain,
      releaseOpponent: state => state.gameState.opponent.envelope.release,
