  ...
  <div class="module">
    ...
    <module-display
      ...
      :knobs="[{name: 'attack', min: 1, max: 100, value: this.attackOpponent},
                ...
                {name: 'amount', min: 1, max: 100, value: this.amountOpponent},
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      attackOpponent: state => state.gameState.opponent.envelope2.attack,
      decayOpponent: state => state.gameState.opponent.envelope2.decay,
      amountOpponent: state => state.gameState.opponent.envelope2.amount,
